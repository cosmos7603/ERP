...
namespace ERP.Controllers
{
	public class ClientController : Controller
	{
		...
		//public ActionResult Create([Bind(Include = "ID,FirstName,LastName,Position")] Person person)
		//{
		...
		//[HttpPost]
		//[ValidateAntiForgeryToken]
		//public ActionResult Edit([Bind(Include = "ID,FirstName,LastName,Position")] Person person)
		//{
		//	if (ModelState.IsValid)
		//	{
