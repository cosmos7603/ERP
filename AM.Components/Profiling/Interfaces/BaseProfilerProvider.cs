...
namespace Corpnet.Profiling
{
    ...
    public abstract class BaseProfilerProvider : IProfilerProvider
    {
        ...
        /// </summary>
        public abstract MiniProfiler Start();
        ...
        /// <summary>
        /// Calls to save the current profiler using the current storage settings
        /// </summary>
		protected static void SaveProfiler(MiniProfiler current)
		{
			if (!MiniProfiler.StorageSuspended)
			{
				...
				if (Settings.Storage == null)
					Settings.Storage = new SqlServerStorage(Settings.ConnectionString);
