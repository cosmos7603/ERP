...
namespace AM.Utils
{
	public class TypeValidator
	{
		...
		public static bool IsDayHours(decimal hours)
		{
			if (hours < 0 || hours > 24)
				return false;
        ...
        /// The Login ID must be between 6 and 18 characters and cannot contain special characters.
        /// Chars Allowed:
        ...
        public static bool IsValidLogin(string s)
        {
            ...
            // Validate special chars and length.
            string pattern = @"([a-z]|[0-9]|-|@|_|\.){4,128}";
