...
$.getAbsoluteUrlFromCurrentController = function (relativePath)
{
...
{
	var indexOfController = currentURL.toLowerCase().indexOf(currentController.toLowerCase());

	var baseUrl = currentURL.substring(0,indexOfController);
	var url = "";
